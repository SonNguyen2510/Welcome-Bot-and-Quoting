...
async def on_message(message):
    ...
    if message.content.startswith('!pa help'):
        ...
        - !addq <keyword> <quote> - Add <quote> to the list of quotes 
        - !clearq <keyword> - Clear <quote> with coresponding from the list of quotes 
        - !listq - List all quotes 
        - !q <keyword> - Speak quote in the voice channel
    ...
    if message.content.startswith('!addq'):
        ...
        if len(args) != 3:
            await message.channel.send('Invalid command format. Usage: !addq keyword "quote"')
            return
        ...
        if len(args) != 2:
            await message.channel.send('Invalid command format. Usage: !clearq keyword')
            return
    ...
    elif message.content.startswith('!listq'):
        try:
            with open("quotes.json", "r") as f:
                quotes = json.load(f)
        except json.decoder.JSONDecodeError:
        ...
        args = message.content.split(' ')
        if len(args) != 2:
            await message.channel.send('Invalid command format. Usage: !q keyword')
            return
